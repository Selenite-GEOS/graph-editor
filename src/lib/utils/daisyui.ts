 ...
 */
export function variant<SemClass extends DaisyUISemClass>(
	semClass: SemClass
): SemClass extends 'base-100' | 'base-200' | 'base-300'
	? `bg-${SemClass} text-base-content`
	: `bg-${SemClass} text-${SemClass}-content` {
